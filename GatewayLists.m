...
- (BOOL)saveGateways:(NSArray *)arr toFork:(NDResourceFork *)aFork withHeader:(NSData *)aHeader name:(NSString *)aName resId:(int)theId {
	...
	//[localHeader appendData:[NSString stringWithFormat: @"%d", defZoneNumber]];
	...
	[tempStr release];
	//NSRange headerRange2 = {11,12};
	//[localHeader appendData:[aHeader subdataWithRange:headerRange2]];	
